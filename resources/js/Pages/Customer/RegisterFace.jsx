...
export default function RegisterFace({ user, storeUrl, backUrl }) {
    ...
    const captureImage = () => {
        ...
        // Only allow capture if all quality checks pass
        const allChecksPass = Object.values(qualityChecks).every(Boolean);
        if (!allChecksPass) {
            return;
        }
                ...
                <div className="mx-auto max-w-5xl space-y-6">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 mt-2">
                            Capture a clear portrait to complete your customer onboarding.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                        <div className="bg-white rounded-2xl shadow-lg p-5 space-y-4">
                            <div className="flex items-center justify-between">
                                <h2 className="text-sm font-semibold text-gray-700">Live Camera (Portrait Mode)</h2>
                        ...
                        <form onSubmit={submit} className="bg-white rounded-2xl shadow-lg p-5 space-y-5">
                            <div>
                                <h2 className="text-sm font-semibold text-gray-700">Quality Requirements</h2>
                            ...
                            <div>
                                <label className="text-sm font-medium text-gray-700">Captured Preview</label>
                                ...
                                {form.errors.face_image && (
                                    <p className="text-red-600 text-sm mt-2">{form.errors.face_image}</p>
                                )}
                            </div>
